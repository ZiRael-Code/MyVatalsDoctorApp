...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: VitalReadingsScreen(),
    );
  }
}

class VitalReadingsScreen extends StatefulWidget {
  @override
  _VitalReadingsScreenState createState() => _VitalReadingsScreenState();
}

class _VitalReadingsScreenState extends State<VitalReadingsScreen>
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            _buildActionButton('Capture Manually', Colors.blue, Colors.white),
            SizedBox(height: 10),
