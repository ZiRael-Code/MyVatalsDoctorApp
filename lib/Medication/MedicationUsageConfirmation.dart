...
void main(){
  runApp(_MedicationUsageConfirmation());
}

class _MedicationUsageConfirmation extends StatefulWidget {
  const _MedicationUsageConfirmation({super.key});
  @override
  MedicationUsageConfirmation createState() => MedicationUsageConfirmation();
}

class MedicationUsageConfirmation extends  State<_MedicationUsageConfirmation> {
