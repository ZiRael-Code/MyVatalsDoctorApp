    ...
    return MaterialApp(
      ...
      children: [
        ...
        Container(
          ...
          child:
        Align(child: Text("You have successfully requested to book an appointment. You will be notified for payment when the doctor approves the appointment.", textAlign: TextAlign.center,
        style: TextStyle(
          fontSize: 14,
        ),
        ),
